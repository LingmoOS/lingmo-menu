...
import org.lingmo.quick.items 1.0 as LingmoItems

LingmoItems.StyleBackground {
    ...
    RowLayout {
        ...
        LingmoItems.Button {
            ...
            icon.mode: parent.currentId === 0 ? LingmoItems.Icon.AutoHighlight : LingmoItems.Icon.Disabled
        ...
        LingmoItems.Button {
            ...
            background.radius: width / 2
            icon.mode: parent.currentId === 1 ? LingmoItems.Icon.AutoHighlight : LingmoItems.Icon.Disabled
