...
void SidebarButtonUtils::openUserCenter()
{
    ...
    LingmoMenu::AppManager::instance()->launchAppWithArguments("/usr/share/applications/lingmo-control-center.desktop", args, "lingmo-control-center");
}

void SidebarButtonUtils::openPeonyComputer()
{
    LingmoMenu::AppManager::instance()->launchAppWithArguments("/usr/share/applications/peony-computer.desktop", QStringList(), "/usr/bin/peony computer:///");
}
