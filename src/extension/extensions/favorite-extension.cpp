...
private:
    ...
    LingmoSearch::ApplicationInfo *m_appInfoTable = nullptr;
};

FavoriteExtension::FavoriteExtension(QObject *parent) : MenuExtensionIFace(parent)
{
    qRegisterMetaType<LingmoMenu::FavoriteAppsModel*>("FavoriteAppsModel*");
...
{
    m_appInfoTable = new LingmoSearch::ApplicationInfo(this);
}
