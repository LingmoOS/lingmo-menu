...
typedef QMap<LingmoMenu::WidgetMetadata::Key, QVariant> MetadataMap;
...
Q_DECLARE_METATYPE(LingmoMenu::MetadataMap)
Q_DECLARE_METATYPE(LingmoMenu::WidgetMetadata::TypeValue)
Q_DECLARE_METATYPE(LingmoMenu::WidgetMetadata::FlagValue)
