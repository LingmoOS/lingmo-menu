...
{
    Q_OBJECT
    Q_PROPERTY(LingmoMenu::AppListHeader *header READ getHeader NOTIFY headerChanged)
    Q_PROPERTY(LingmoMenu::LabelBottle *labelBottle READ labelBottle NOTIFY labelBottleChanged)
public:
...
Q_DECLARE_METATYPE(LingmoMenu::AppListModel*)
Q_DECLARE_METATYPE(LingmoMenu::AppListHeader*)
