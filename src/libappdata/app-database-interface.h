...
Q_SIGNALS:
     ...
     * @param apps 新增加的应用
     */
    void appAdded(const LingmoMenu::DataEntityVector &apps);

    /**
     * 更新的应用及其属性列表
     * @param updates
     */
    void appUpdated(const QVector<QPair<LingmoMenu::DataEntity, QVector<int> > > &updates);
...
Q_DECLARE_METATYPE(LingmoMenu::DataEntityVector)
